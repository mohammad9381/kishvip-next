             ...
             >
                <header class="site-header mo-left header-transparent header navstyle3">
                    <div class={`sticky-header main-bar-wraper ${active} navbar-expand-lg`}>
                        <div class="main-bar bg-black clearfix ">
                            <div class="container clearfix">
                                ...
                                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                                    ...
                                    <ul class="nav navbar-nav">
                                        <li class="has-mega-menu homedemo"> <Link href="#">Home<i class="fa fa-chevron-down"></i></Link>
                                            <ul class="mega-menu">
                                    ...
                                    <div class="dlab-social-icon">
                                        <ul>
                                            <li><Link class="site-button facebook sharp-sm fa fa-facebook" to="#"></Link></li>
                                            <li><Link class="site-button twitter sharp-sm fa fa-twitter" to="#"></Link></li>
                                            <li><Link class="site-button linkedin sharp-sm fa fa-linkedin" to="#"></Link></li>
                                            <li><Link class="site-button instagram sharp-sm fa fa-instagram" to="#"></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
