                    ...
                    <div class="container-fluid">
                        <div class="middle-area">
                            <div class="logo-header">
                                <Link href="/"><img src={("/images/logo-light.png")} alt=""/></Link>
                            </div>
                            ...
                            <div class="container-fluid clearfix">
                                ...
                                <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                                    ...
                                    <div class="dlab-social-icon">
                                        <ul>
                                            <li><Link class="site-button sharp-sm fa fa-facebook" to="/#"></Link></li>
                                            <li><Link class="site-button sharp-sm fa fa-twitter" to="/#"></Link></li>
                                            <li><Link class="site-button sharp-sm fa fa-linkedin" to="/#"></Link></li>
                                            <li><Link class="site-button sharp-sm fa fa-instagram" to="/#"></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
