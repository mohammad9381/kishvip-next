    ...
    render() {
        return (
            ...
            <footer class="site-footer">
                <div class="footer-top overlay-black-light" style={{ backgroundImage: "url(" + bg + ")" }}>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-xl-5 col-lg-4 col-sm-8 footer-col-4">
                                <div class="widget">
                                    ...
                                    <ul class="list-inline m-a0">
                                        <li><Link href="#" class="site-button btnhover20 facebook circle "><i class="fa fa-facebook"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 google-plus circle "><i class="fa fa-google-plus"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 linkedin circle "><i class="fa fa-linkedin"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 instagram circle "><i class="fa fa-instagram"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 twitter circle "><i class="fa fa-twitter"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
