                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="dlab-topbar-right topbar-social">
                                ...
                                <ul>
                                    <li><Link href="/#" class="site-button circle-sm facebook sharp-sm"><i class="fa fa-facebook"></i></Link></li>
                                    <li><Link href="/#" class="site-button circle-sm google-plus"><i class="fa fa-google-plus"></i></Link></li>
                                    <li><Link href="/#" class="site-button circle-sm twitter"><i class="fa fa-twitter"></i></Link></li>
                                    <li><Link href="/#" class="site-button circle-sm instagram"><i class="fa fa-instagram"></i></Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="main-bar clearfix ">
                            <div class="container clearfix">
                                <div class="logo-header mostion">
                                    <Link href="/"><img src={("/images/logo-center.png")} class="logo1" alt=""/><img src={("/images/logo-center-light.png")} class="logo2" alt=""/></Link>
                                </div>
