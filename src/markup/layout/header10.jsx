                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="dlab-topbar-right">
                                <Link href="/contact-1" class="site-button btnhover21 radius-no">GET A QUOTE</Link>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="container clearfix">
                                ...
                                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                                    ...
                                    <div class="dlab-social-icon">
                                        <ul>
                                            <li><Link class="site-button circle fa fa-facebook" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button  circle fa fa-twitter" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button circle fa fa-linkedin" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button circle fa fa-instagram" to="/javascript:void(0);"></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
