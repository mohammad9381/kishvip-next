                            ...
                            <div class="container clearfix">
                                ...
                                <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                                    <div class="logo-header d-md-block d-lg-none">
                                        <Link href="/"><img src={("/images/logo-5.png")} alt=""/></Link>
                                    </div>
                                    ...
                                    <div class="dlab-social-icon ind-social">
                                        <ul>
                                            <li><Link class="site-button-link facebook fa fa-facebook" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button-link twitter fa fa-twitter" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button-link linkedin fa fa-linkedin" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button-link instagram fa fa-instagram" to="/javascript:void(0);"></Link></li>
                                        </ul>
                                        <p>2019 Industry</p>
                                    </div>
                                </div>
