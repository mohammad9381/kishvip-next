                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="dlab-topbar-right">
                                <Link href="/contact-1" class="site-button radius-no btnhover11">GET A QUOTE</Link>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="container clearfix">
                                ...
                                <div class="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                                    ...
                                    <div class="dlab-social-icon">
                                        <ul>
                                            <li><Link class="site-button facebook sharp-sm outline fa fa-facebook" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button twitter sharp-sm outline fa fa-twitter" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button linkedin sharp-sm outline fa fa-linkedin" to="/javascript:void(0);"></Link></li>
                                            <li><Link class="site-button instagram sharp-sm outline fa fa-instagram" to="/javascript:void(0);"></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
