...
class Footer15 extends Component {
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 wow fadeIn" data-wow-delay="0.4s">
                                <div class="widget">
                                    ...
                                    <ul class="list-inline m-a0">
                                        <li><Link href="#" class="site-button btnhover20 facebook sharp"><i class="fa fa-facebook"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 google-plus sharp"><i class="fa fa-google-plus"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 linkedin sharp"><i class="fa fa-linkedin"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 instagram sharp"><i class="fa fa-instagram"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover20 twitter sharp"><i class="fa fa-twitter"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
