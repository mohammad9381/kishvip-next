                        ...
                        <div class="container">
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="dlab-topbar-right">
                                    <Link href={'/#'} class="site-button radius-no">GET A QUOTE</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="main-bar clearfix ">
                                <div class="container clearfix">
                                    ...
                                    <div class="logo-header mostion">
                                        <Link href={'/'}><img src={require('/images/logo.png')} alt="" /></Link>
                                    </div>
                                    ...
                                    <div class={`header-nav navbar-collapse collapse justify-content-end`} id="navbarNavDropdown">
                                        ...
                                        <div class="dlab-social-icon">
                                            <ul>
                                                <li><Link class="site-button circle fa fa-facebook" to={'/#'}></Link></li>
                                                <li><Link class="site-button  circle fa fa-twitter" to={'/#'}></Link></li>
                                                <li><Link class="site-button circle fa fa-linkedin" to={'/#'}></Link></li>
                                                <li><Link class="site-button circle fa fa-instagram" to={'/#'}></Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
