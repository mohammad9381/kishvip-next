...
class Footer10 extends Component {
                                        ...
                                        <form class="dzSubscribe" action="script/mailchamp.php" method="post">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button name="submit" value="Submit" type="submit" class="site-button black btnhover21 radius-xl">Subscribe</button>
                                                </span>
                                            </div>
                                        </form>
                                    </div>
                                    <ul class="list-inline m-a0">
                                        <li><Link href="#" class="site-button btnhover21 facebook circle "><i class="fa fa-facebook"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover21 google-plus circle "><i class="fa fa-google-plus"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover21 linkedin circle "><i class="fa fa-linkedin"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover21 instagram circle "><i class="fa fa-instagram"></i></Link></li>
                                        <li><Link href="#" class="site-button btnhover21 twitter circle "><i class="fa fa-twitter"></i></Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
