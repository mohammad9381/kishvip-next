...
class ComingSoon1 extends Component {
    ...
    render() {
        return (
            <>
            <div id="rev_slider_152_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="coming-soon" data-source="gallery" style={{backgroundColor:"#222222",padding:"0px"}}>
                <div id="rev_slider_152_1" class="rev_slider fullscreenbanner" style={{display:"none"}} data-version="5.4.1">
                    <ul>
                        <li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            ...
                            <Link class="tp-caption tp-resizeme" target="_blank" to="#" id="slide-414-layer-16"
                                data-x="['left','left','left','left']" data-hoffset="['100','50','50','30']"
                            ...
                            <Link class="tp-caption tp-resizeme" target="_blank" to="#" id="slide-414-layer-18"
                                ...
                                style={{zIndex:"18",fontSize:"20px",lineHeight:"60px",fontWeight:"400",width:"60px",height:"60px",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Open Sans",border:"2px solid rgba(255, 255, 255, 1.00)",borderRadius:"50%"}}><i class="fa fa-google-plus"></i> </Link>
                        </li>
                    </ul>
