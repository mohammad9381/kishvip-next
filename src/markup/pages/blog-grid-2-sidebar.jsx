                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-7">
                                <div id="masonry" class="dlab-blog-grid-2">
                                    <div class="row">
                                        <div class="post card-container col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="dlab-info p-a20 border-1">
                                                    <div class="dlab-post-meta">
                                                        <ul>
                                                            ...
                                                            <li class="post-author"> By <Link href="/#">Josephine</Link> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="dlab-post-title">
                                                ...
                                                <div class="dlab-info p-a20 border-1">
                                                    <div class="dlab-post-meta">
                                                        <ul>
                                                            ...
                                                            <li class="post-author"> By <Link href="/#">Alexander</Link> </li>
                                                        </ul>
                                                    </div>
                                                    <div class="dlab-post-title">
