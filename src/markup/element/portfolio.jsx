                    ...
                    <div className={collumnCls}>
                      <div class="dlab-box dlab-gallery-box">
                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                            <Link href="/portfolio-details"> <img src={image.imgUrl}  alt=""/> </Link>
                            <div class="overlay-bx">
                                <div class="overlay-icon">
                                    <div class="text-white">
                                        <Link href="/portfolio-details"><i class="fa fa-link icon-bx-xs"></i></Link>
                        ...
                        <div class="dez-info p-a30 bg-white">
                            <p class="dez-title m-t0"><Link href="/portfolio-details">{image.title}</Link></p>
