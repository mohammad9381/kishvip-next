...
const content = [
    {
        image: ("/images/our-services/construct/pic1.jpg"),
    },
    {
        image: ("/images/our-services/construct/pic2.jpg"),
    },
]
                        ...
                        <div class="project-info-box">
                            ...
                            <div class="project-content">
                                <ul class="list-details">
                                    ...
                                    <li>
                                        <Link href="/portfolio-details" class="site-button btnhover20 m-t10">View Portfolio</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
